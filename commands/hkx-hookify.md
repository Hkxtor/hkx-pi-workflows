...
# /hkx-hookify — Create a behavior guardrail
...
- paths written
- how to list: `/hkx-hookify-list`
- how to toggle: `/hkx-hookify-configure`
...
```text
/hkx-hookify warn on console.log in TypeScript writes
/hkx-hookify block rm -rf outside /tmp
/hkx-hookify
```
