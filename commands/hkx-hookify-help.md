---
name: hkx-hookify-help
description: Operator help for the Hookify behavior-guardrail system (events, format, paths, limits).
---

# /hkx-hookify-help — Hookify documentation

Hookify creates **rule files** enforced by the Pi extension `hkx-hookify` to warn or block unwanted agent tool use.

## Commands

| Command | Purpose |
| --- | --- |
| `/hkx-hookify [description]` | Create rules (conversation analysis if no args) |
| `/hkx-hookify-list` | List project + global rules |
| `/hkx-hookify-configure` | Enable / disable rules |
| `/hkx-hookify-help` | This help |
