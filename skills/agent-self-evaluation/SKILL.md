...
Use the template below. The report must include:
...
- `ai-regression-testing` — Systematic regression testing for AI-assisted development, including sandbox-mode testing and catching agent blind spots.
