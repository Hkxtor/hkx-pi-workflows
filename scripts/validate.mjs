...
const requiredFiles = [
	...
	"extensions/hkx-custom-header.ts",
...
async function main() {
	...
	try {
		...
		if (Object.hasOwn(agentSettings, "theme")) {
			errors.push(
				`configs/agent-settings.json must not set theme (got ${JSON.stringify(agentSettings.theme)})`,
			);
		}
	} catch (err) {
